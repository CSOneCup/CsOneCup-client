...
class _MyDeckPageState extends State<MyDeckPage> {
  ...
  List _originalDeckList = <Deck>[];   // 실제 데이터
  List _deckList = <Deck>[];
  String _searchText = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: const TextStyle(fontSize: 12, color: AppColors.mainDeepOrange),
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(_deckList[i * 3].getDeckName(), style: TextStyle(fontSize: 10),)
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      Text(_deckList[i * 3 + 1].getDeckName(), style: TextStyle(fontSize: 10),)
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      Text(_deckList[i * 3 + 2].getDeckName(), style: TextStyle(fontSize: 10),)
                    ],
                  ),
                ],
              );
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => DeckCreatePage()));
        },
        tooltip: 'Create Deck',
